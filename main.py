...
s1 = BooleanVar()
set1 = Checkbutton(setup_container, text="Auto punctuation", selectcolor=focus_color, variable=s1
                   , onvalue=True, offvalue=False)
set1.grid(row=0, column=0)
s2 = BooleanVar()
set2 = Checkbutton(setup_container, text="Case sensitive", selectcolor=focus_color, variable=s2
                   , onvalue=True, offvalue=False)
